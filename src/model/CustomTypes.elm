module CustomTypes exposing (Build, CategoryUnionType(..), Character, CharacterSkill, Crest, CrestHolder(..), GenderUnionType(..), House(..), Job, JobCategory, JobDescription, JobSkill, MagicUsage(..), MasterySkill, Proficiency, Rank(..), Skill, SkillType(..), SortType(..), StandardSkill, Study, StudyCapacity(..), Subject(..))
