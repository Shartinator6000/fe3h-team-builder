module DataHandler exposing (getBlackEaglesTeam, getBlueLionsTeam, getGoldenDeerTeam, initBuild, initStaticData, initTeam, mockBuilds)
...
getGoldenDeerTeam : Dict Int Build
getGoldenDeerTeam =
    let
        characterIds =
